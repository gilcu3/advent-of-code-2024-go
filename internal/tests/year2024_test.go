...
func Benchmark202421(b *testing.B) {
	aoc.RegisterYears()
	input := util.TestInput(2024, 21)
	p := aoc.NewPuzzle(2024, 21)
	if p.Part1(input) != fmt.Sprint(nil) {
		b.Run("Part1", func(b *testing.B) {
			b.ResetTimer()
			for i := 0; i < b.N; i++ {
...
func Benchmark202422(b *testing.B) {
	aoc.RegisterYears()
	input := util.TestInput(2024, 22)
	p := aoc.NewPuzzle(2024, 22)
	if p.Part1(input) != fmt.Sprint(nil) {
		b.Run("Part1", func(b *testing.B) {
			b.ResetTimer()
			for i := 0; i < b.N; i++ {
...
func Benchmark202423(b *testing.B) {
	aoc.RegisterYears()
	input := util.TestInput(2024, 23)
	p := aoc.NewPuzzle(2024, 23)
	if p.Part1(input) != fmt.Sprint(nil) {
		b.Run("Part1", func(b *testing.B) {
			b.ResetTimer()
			for i := 0; i < b.N; i++ {
...
func Benchmark202424(b *testing.B) {
	aoc.RegisterYears()
	input := util.TestInput(2024, 24)
	p := aoc.NewPuzzle(2024, 24)
	if p.Part1(input) != fmt.Sprint(nil) {
		b.Run("Part1", func(b *testing.B) {
			b.ResetTimer()
			for i := 0; i < b.N; i++ {
...
func Benchmark202425(b *testing.B) {
	aoc.RegisterYears()
	input := util.TestInput(2024, 25)
	p := aoc.NewPuzzle(2024, 25)
	if p.Part1(input) != fmt.Sprint(nil) {
		b.Run("Part1", func(b *testing.B) {
			b.ResetTimer()
			for i := 0; i < b.N; i++ {
